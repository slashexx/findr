...
public class Login extends AppCompatActivity {
    ...
    public void checkUser() {
        ...
        String storedPassword = userPrefs.getString(userEmail + "_password", null);
        ...
        if (storedPassword != null && storedPassword.equals(userPassword)) {
            ...
            startActivity(intent);
             ...
             Toast.makeText(Login.this, "Invalid Credentials or User not found.", Toast.LENGTH_SHORT).show();
        }
    }
}
